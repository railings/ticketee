Feature:
  In order to to clean up the user experience
  As the system
  ...
  Scenario: Delete project link is hidden from signed-in users
    Given I am signed in as "user@ticketee.com"
    When I follow "TextMate 2"
  ...
  Scenario: New ticket link is show to users with permission
  ...
  Scenario: Edit ticket link is shown to users with permission
    Given "user@ticketee.com" can view the "TextMate 2" project
  ...
  Scenario: Deleting ticket link is shown to a user with permission
    Given "user@ticketee.com" can view the "TextMate 2" project
  ...
  Scenario: Deleting ticket link is hidden from user without permission
    Given "user@ticketee.com" can view the "TextMate 2" project
    And I am signed in as "user@ticketee.com"
    When I follow "TextMate 2"
    And I follow "Shiny!"
  ...
  Scenario: Deleting ticket link is shown to admins
    Given I am signed in as "admin@ticketee.com"
    When I follow "TextMate 2"
    And I follow "Shiny!"
    Then I should see the "Delete" link
